...
var _typeof = typeof Symbol === "function" && _typeof2(Symbol.iterator) === "symbol" ? function (obj) {
	...
	var request = new XMLHttpRequest();if (isDef(options)) {
		if (options.forceReload) {
			var rnd = Math.random();url += url.indexOf("?") === -1 ? "?" : "&";url += "___t=" + rnd;
		}
	}request.open("GET", url, true);request.onload = function () {
		if (request.status >= 200 && request.status < 400) {
			if (onSuccess) {
				var result = "";if (request.status === 200) {
			...
			console.error("ajax error", request);if (onError) {
				onError(request);
			}
		}
	};request.send();
};document.ajax = function (method, url, data, onSuccess, onError) {
	var request = new XMLHttpRequest();request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");request.open(method, url, true);request.onload = function () {
		if (request.status >= 200 && request.status < 400) {
			if (onSuccess) {
	...
	var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
		for (var _iterator = arrScriptsUrl[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			var url = _step.value;qs("body").beforeEnd(newElement("script", { src: url }));
		}
	} catch (err) {
	...
	var media = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "all";var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
		for (var _iterator2 = arrStylessUrl[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
			var url = _step2.value;qs("body").beforeEnd(newElement("link", { rel: "stylesheet", type: "text/css", href: url, media: media }));
		}
	} catch (err) {
...
};HTMLButtonElement.prototype.setNoChanges = function () {};HTMLButtonElement.prototype.isModified = function () {
	return false;
};HTMLElement.prototype.addClass = function (className) {
	var classes = className.split(" ");for (var i = 0; i < classes.length; i++) {
		var cl = classes[i];if (this.classList.contains(cl)) {
			continue;
		}this.classList.add(cl);
	}return this;
};HTMLElement.prototype.removeClass = function (className) {
	var classes = className.split(" ");this.classList.remove(classes);return this;
	...
	var classes = classNames.split(" ");for (var i = 0; i < classes.length; i++) {
		var cl = classes[i];if (cl[0] === "-") {
			cl = cl.substring(1);if (this.classList.contains(cl)) {
				this.classList.remove(cl);
			}
		} else {
			if (cl[0] === "+") {
	...
	var s = this.style;if (arguments.length === 1 && typeof cssProperty === "string") {
	...
	if (withMargin) {
		var height = this.offsetHeight;var style = getComputedStyle(this);height += parseInt(style.marginTop, 10) + parseInt(style.marginBottom, 10);return height;
	}return this.offsetHeight;
};HTMLElement.prototype.outerWidth = function (withMargin) {
	if (withMargin) {
		var width = this.offsetWidth;var style = getComputedStyle(this);width += parseInt(style.marginLeft, 10) + parseInt(style.marginRight, 10);return width;
	...
	var it = item;if (isDef(item)) {
		while (it.parentNode !== null && it !== this) {
			it = it.parentNode;
		}return it === this;
	}return false;
};HTMLElement.prototype.offset = function () {
	var rect = this.getBoundingClientRect();return { top: rect.top + document.body.scrollTop, left: rect.left + document.body.scrollLeft };
	...
	var dic = {};var formdata = new FormData(this);var done = false;var iterator = formdata.entries();do {
		var prop = iterator.next();if (prop.done && !prop.value) {
			done = true;
		} else {
			dic[prop.value[0]] = prop.value[1];
		}
	} while (!done);return dic;
};HTMLFormElement.prototype.setInputs = function (obj) {
	var triggerChange = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;var evt = new Event("change");for (var key in obj) {
		var val = obj[key];var inputs = this.qsa("[name='" + key + "']");if (inputs) {
			if (inputs.length > 1) {
				var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {
					for (var _iterator3 = inputs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
						var input = _step3.value;if (input.checked) {
							input.checked = false;
						}var vals = String(val).split(",");var _iteratorNormalCompletion4 = true;var _didIteratorError4 = false;var _iteratorError4 = undefined;try {
							for (var _iterator4 = vals[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
								var v = _step4.value;if (input.value === v) {
									input.checked = true;if (triggerChange) {
				...
				var _input = inputs[0];if (_input.type === "checkbox") {
					if (_input.checked) {
	...
	var inputs = this.elements;var _iteratorNormalCompletion5 = true;var _didIteratorError5 = false;var _iteratorError5 = undefined;try {
		for (var _iterator5 = inputs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
			var input = _step5.value;input.setNoChanges();
		}
	} catch (err) {
	...
	var inputs = this.elements;var _iteratorNormalCompletion6 = true;var _didIteratorError6 = false;var _iteratorError6 = undefined;try {
		for (var _iterator6 = inputs[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
			var input = _step6.value;if (input.isModified()) {
				return true;
			}
		}
	} catch (err) {
	...
	var type = this.attr("type");if (type === "text") {
		this.attr("type", "password");
	...
	var type = this.attr("type");if (type === "checkbox" || type === "radio") {
	...
	if (!!this.value) {
		return this.value;
	}var value = "";var _iteratorNormalCompletion7 = true;var _didIteratorError7 = false;var _iteratorError7 = undefined;try {
		for (var _iterator7 = this.selectedOptions[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
			var opt = _step7.value;value += opt.value + ",";
		}
	} catch (err) {
	...
	var _this = this;this.options.length = 0;data.forEach(function (element) {
		var option = newElement("option");option.text = element[keyName];option.value = element[valueName];if (linkData) {
			option.data = element;
		}_this.add(option);
	});
	...
	text = text || "";if (document.selection) {
		this.focus();var sel = document.selection.createRange();sel.text = text;
	} else if (this.selectionStart || this.selectionStart === 0) {
		var startPos = this.selectionStart;var endPos = this.selectionEnd;this.value = this.value.substring(0, startPos) + text + this.value.substring(endPos, this.value.length);this.selectionStart = startPos + text.length;this.selectionEnd = startPos + text.length;
	} else {
		this.value += text;
	}
	...
	var value = this.value;var id = this.name + "_old";var elem = qsi(id);if (elem === null) {
		var elem = newElement("div", { id: this.name + "_old" }, value, null, { display: "none" });this.afterEnd(elem);
	} else {
		elem.innerHTML = value;
	}
};HTMLTextAreaElement.prototype.isModified = function () {
	var id = this.name + "_old";var elem = qsi(id);if (elem == null) {
		return false;
	}return elem.innerHTML !== this.value;
};window.newElement = function (tagName, attributes, htmlContent, events, css) {
	var tag = document.createElement(tagName);if (attributes) {
	...
	NodeList.prototype.forEach = function (fn) {
		if (fn) {
			for (var i = 0; i < this.length; i++) {
				var it = this[i];fn(it, i, this);
			}
		}
	};
}NodeList.prototype.forObject = function (fn) {
	debugger;fn.apply(null, this);
	...
	this.forEach(function (it) {
		return it.class(classNames);
	});return this;
};NodeList.prototype.attr = function () {
	var _arguments = arguments;this.forEach(function (it) {
		return it.attr(_arguments);
	});return this;
...
!function (e, n) {
	"object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) && "undefined" != typeof module ? n() : "function" == typeof define && define.amd ? define(n) : n();
}(0, function () {
	"use strict";
	function e() {}function n(e) {
		if (!(this instanceof n)) throw new TypeError("Promises must be constructed via new");if ("function" != typeof e) throw new TypeError("not a function");this._state = 0, this._handled = !1, this._value = undefined, this._deferreds = [], f(e, this);
	}function t(e, t) {
		for (; 3 === e._state;) {
			e = e._value;
		...
		try {
			if (t === e) throw new TypeError("A promise cannot be resolved with itself.");if (t && ("object" == (typeof t === "undefined" ? "undefined" : _typeof2(t)) || "function" == typeof t)) {
				var o = t.then;if (t instanceof n) return e._state = 3, e._value = t, void i(e);if ("function" == typeof o) return void f(function (e, n) {
					return function () {
						e.apply(n, arguments);
					};
				}(o, t), e);
		...
		var t = !1;try {
			...
			if (t) return;t = !0, r(n, i);
		}
	}var u = setTimeout;n.prototype["catch"] = function (e) {
		return this.then(null, e);
	}, n.prototype.then = function (n, o) {
		var r = new this.constructor(e);return t(this, new function (e, n, t) {
		...
		return new n(function (n, t) {
			function o(e, f) {
				try {
					if (f && ("object" == (typeof f === "undefined" ? "undefined" : _typeof2(f)) || "function" == typeof f)) {
		...
		return e && "object" == (typeof e === "undefined" ? "undefined" : _typeof2(e)) && e.constructor === n ? e : new n(function (n) {
			n(e);
		});
	}, n.reject = function (e) {
		return new n(function (n, t) {
		...
		if ("undefined" != typeof self) return self;if ("undefined" != typeof window) return window;if (void 0 !== c) return c;throw Error("unable to locate global object");
    ...
    */
      ...
      */
					updateElement: function updateElement(point, index, reset) {
						...
						var x = reset ? xScale.getPixelForDecimal(0.5) : xScale.getPixelForValue((typeof data === "undefined" ? "undefined" : _typeof2(data)) === 'object' ? data : NaN, index, dsIndex);
			...
			module.exports = function (Chart) {
				...
				Chart.controllers.line = Chart.DatasetController.extend({
					...
					updateElement: function updateElement(point, index, reset) {
						...
						x = xScale.getPixelForValue((typeof value === "undefined" ? "undefined" : _typeof2(value)) === 'object' ? value : NaN, index, datasetIndex);
    ...
    */
     ...
     */
					...
					update: function update(config) {
						...
						if (!config || (typeof config === "undefined" ? "undefined" : _typeof2(config)) !== 'object') {
     ...
     */
			...
			function interpolate(start, view, model, ease) {
				...
				for (i = 0, ilen = keys.length; i < ilen; ++i) {
					...
					type = typeof target === "undefined" ? "undefined" : _typeof2(target);

					if (type === (typeof origin === "undefined" ? "undefined" : _typeof2(origin))) {
						if (type === 'string') {
							c0 = color(origin);
							if (c0.valid) {
								c1 = color(target);
    ...
    */
     ...
     */
				...
				drawPoint: function drawPoint(ctx, style, radius, x, y, rotation) {
					...
					if (style && (typeof style === "undefined" ? "undefined" : _typeof2(style)) === 'object') {
						type = style.toString();
