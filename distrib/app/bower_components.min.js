"use strict";var _typeof2=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==="undefined"?"undefined":_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==="undefined"?"undefined":_typeof2(obj);};document.ready=function(fn){if(document.attachEvent?document.readyState==="complete":document.readyState!=="loading"){fn();}else{document.addEventListener('DOMContentLoaded',fn);}};document.getJSON=function(url,onSuccess,onError){var request=new XMLHttpRequest();request.open('GET',url,true);request.onload=function(){if(request.status>=200&&request.status<400){if(onSuccess){onSuccess(JSON.parse(request.responseText));}}else{if(onError){onError(request);}}};request.send();};document.ajax=function(method,url,data,onSuccess,onError){var request=new XMLHttpRequest();request.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');request.open(method,url,true);request.onload=function(){if(request.status>=200&&request.status<400){if(onSuccess){onSuccess(request.responseText);}}else{if(onError){onError(request);}}};request.send(data);};HTMLElement.prototype.addClass=function(className){this.setAttribute("class",this.getAttribute("class")||""+" "+className);return this;};HTMLElement.prototype.removeClass=function(className){var cl=this.getAttribute("class")||"";cl=cl.replace(className,"").trim();this.setAttribute("class",cl);return this;};HTMLElement.prototype.toggleClass=function(className){var cl=this.getAttribute("class")||"";if(cl==="")return this.addClass(className);return this.removeClass(className);};HTMLElement.prototype.css=function(cssProperty,cssValue){var s=this.style;if(arguments.length===1&&typeof cssProperty==="string"){return s[cssProperty];}if((typeof cssProperty==="undefined"?"undefined":_typeof(cssProperty))==="object"){for(var p in cssProperty){s[p]=cssProperty[p];}}else{this.style[cssProperty]=cssValue;}return this;};HTMLElement.prototype.appendTo=function(html){if(typeof html!=="string"){console.error("appendTo:",html," is not a string");}this.insertAdjacentHTML("beforeend",html);return this;};HTMLElement.prototype.before=function(html){this.insertAdjacentHTML('beforebegin',html);};HTMLElement.prototype.after=function(html){this.insertAdjacentHTML('afterend',html);};HTMLElement.prototype.append=function(elem){this.parent.appendChild(elem);};HTMLElement.prototype.prepend=function(elem){this.parent.insertBefore(elem,this.parent.firstChild);};HTMLElement.prototype.outerHeight=function(withMargin){//return (this.parentElement) ? this.parentElement.clientHeight : 0;
if(withMargin){var height=this.offsetHeight;var style=getComputedStyle(this);height+=parseInt(style.marginTop)+parseInt(style.marginBottom);return height;}else{return this.offsetHeight;}};HTMLElement.prototype.outerWidth=function(withMargin){if(withMargin){var width=this.offsetWidth;var style=getComputedStyle(this);width+=parseInt(style.marginLeft)+parseInt(style.marginRight);return width;}else{return this.offsetWidth;}//return (this.parentElement) ? this.parentElement.clientWidth : 0;
};HTMLElement.prototype.hide=function(){this.style.display="none";};HTMLElement.prototype.show=function(){this.css({"display":"",visibility:""});};HTMLElement.prototype.isVisible=function(){return this.css("display")!=="none";};HTMLElement.prototype.toggleVisible=function(){if(this.isVisible()){return this.hide();}return this.show();};HTMLElement.prototype.html=function(st){if(arguments.length===0)return this.innerHTML;this.innerHTML=st;return this;};HTMLElement.prototype.text=function(){return this.textContent;};HTMLElement.prototype.outerHtml=function(st){if(arguments.length===1){this.outerHTML=st;}else{return this.outerHTML;}};HTMLElement.prototype.attr=function(name,value){if(arguments.length===2){this.setAttribute(name,value);}else{return this.getAttribute(name);}};HTMLElement.prototype.offset=function(){//return { top: this.offsetLeft, left: this.offsetTop };
var rect=this.getBoundingClientRect();return{top:rect.top+document.body.scrollTop,left:rect.left+document.body.scrollLeft};};HTMLElement.prototype.on=function(evtName,fn,useCapture){if(this.addEventListener){//this.addEventListener(evtName, fn, useCapture || false);
this[evtName]=fn;}else if(this.attachEvent){this.attachEvent(evtName,fn);}};HTMLElement.prototype.off=function(eventName,eventHandler){this.removeEventListener(eventName,eventHandler);};HTMLTextAreaElement.prototype.insertAtCaret=function(text){text=text||'';if(document.selection){// IE
this.focus();var sel=document.selection.createRange();sel.text=text;}else if(this.selectionStart||this.selectionStart===0){// Others
var startPos=this.selectionStart;var endPos=this.selectionEnd;this.value=this.value.substring(0,startPos)+text+this.value.substring(endPos,this.value.length);this.selectionStart=startPos+text.length;this.selectionEnd=startPos+text.length;}else{this.value+=text;}};!function(e,n){"object"==(typeof exports==="undefined"?"undefined":_typeof2(exports))&&"undefined"!=typeof module?n():"function"==typeof define&&define.amd?define(n):n();}(0,function(){"use strict";function e(){}function n(e){if(!(this instanceof n))throw new TypeError("Promises must be constructed via new");if("function"!=typeof e)throw new TypeError("not a function");this._state=0,this._handled=!1,this._value=undefined,this._deferreds=[],f(e,this);}function t(e,t){for(;3===e._state;){e=e._value;}0!==e._state?(e._handled=!0,n._immediateFn(function(){var n=1===e._state?t.onFulfilled:t.onRejected;if(null!==n){var i;try{i=n(e._value);}catch(f){return void r(t.promise,f);}o(t.promise,i);}else(1===e._state?o:r)(t.promise,e._value);})):e._deferreds.push(t);}function o(e,t){try{if(t===e)throw new TypeError("A promise cannot be resolved with itself.");if(t&&("object"==(typeof t==="undefined"?"undefined":_typeof2(t))||"function"==typeof t)){var o=t.then;if(t instanceof n)return e._state=3,e._value=t,void i(e);if("function"==typeof o)return void f(function(e,n){return function(){e.apply(n,arguments);};}(o,t),e);}e._state=1,e._value=t,i(e);}catch(u){r(e,u);}}function r(e,n){e._state=2,e._value=n,i(e);}function i(e){2===e._state&&0===e._deferreds.length&&n._immediateFn(function(){e._handled||n._unhandledRejectionFn(e._value);});for(var o=0,r=e._deferreds.length;r>o;o++){t(e,e._deferreds[o]);}e._deferreds=null;}function f(e,n){var t=!1;try{e(function(e){t||(t=!0,o(n,e));},function(e){t||(t=!0,r(n,e));});}catch(i){if(t)return;t=!0,r(n,i);}}var u=setTimeout;n.prototype["catch"]=function(e){return this.then(null,e);},n.prototype.then=function(n,o){var r=new this.constructor(e);return t(this,new function(e,n,t){this.onFulfilled="function"==typeof e?e:null,this.onRejected="function"==typeof n?n:null,this.promise=t;}(n,o,r)),r;},n.prototype["finally"]=function(e){var n=this.constructor;return this.then(function(t){return n.resolve(e()).then(function(){return t;});},function(t){return n.resolve(e()).then(function(){return n.reject(t);});});},n.all=function(e){return new n(function(n,t){function o(e,f){try{if(f&&("object"==(typeof f==="undefined"?"undefined":_typeof2(f))||"function"==typeof f)){var u=f.then;if("function"==typeof u)return void u.call(f,function(n){o(e,n);},t);}r[e]=f,0==--i&&n(r);}catch(c){t(c);}}if(!e||"undefined"==typeof e.length)throw new TypeError("Promise.all accepts an array");var r=Array.prototype.slice.call(e);if(0===r.length)return n([]);for(var i=r.length,f=0;r.length>f;f++){o(f,r[f]);}});},n.resolve=function(e){return e&&"object"==(typeof e==="undefined"?"undefined":_typeof2(e))&&e.constructor===n?e:new n(function(n){n(e);});},n.reject=function(e){return new n(function(n,t){t(e);});},n.race=function(e){return new n(function(n,t){for(var o=0,r=e.length;r>o;o++){e[o].then(n,t);}});},n._immediateFn="function"==typeof setImmediate&&function(e){setImmediate(e);}||function(e){u(e,0);},n._unhandledRejectionFn=function(e){void 0!==console&&console&&console.warn("Possible Unhandled Promise Rejection:",e);};var c=function(){if("undefined"!=typeof self)return self;if("undefined"!=typeof window)return window;if(void 0!==c)return c;throw Error("unable to locate global object");}();c.Promise||(c.Promise=n);});/*!
 * Chart.js
 * http://chartjs.org/
 * Version: 2.7.2
 *
...
//! license : MIT
//! momentjs.com
;(function(global,factory){(typeof exports==="undefined"?"undefined":_typeof2(exports))==='object'&&typeof module!=='undefined'?module.exports=factory():typeof define==='function'&&define.amd?define(factory):global.moment=factory();})(this,function(){'use strict';var hookCallback;function hooks(){return hookCallback.apply(null,arguments);}// This is done to register the method called with moment()
